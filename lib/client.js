...
const copy = {
	...
	en: {
		...
		crew: "Crew-created only",
		worktree: "Crew workspaces only (recommended)",
...
function HistoryPanel({ locale }) {
	...
	const [scope, setScope] = (0, react.useState)("worktree");
	const timeScoped = scope === "before" || scope === "worktree";
	...
	return /* @__PURE__ */ (0, react_jsx_runtime.jsxs)("details", {
		...
		children: [/* @__PURE__ */ (0, react_jsx_runtime.jsx)("summary", {
			...
			children: [
				...
				timeScoped && /* @__PURE__ */ (0, react_jsx_runtime.jsxs)("label", { children: [
					t.time,
					" ",
				...
				/* @__PURE__ */ (0, react_jsx_runtime.jsx)("button", {
					type: "button",
					style,
					disabled: locked || !connected || timeScoped && before !== "" && !Number.isFinite(new Date(before).getTime()) || scope === "before" && before === "",
					onClick: () => void act("preview", {
						operation,
						scope,
						...timeScoped && before !== "" ? { before: new Date(before).toISOString() } : {}
					}),
					children: t.preview
				}),
...
const COPY = {
	...
	en: {
		...
		harnessProviders: "Harness Providers",
		harnessProviderHint: "Live Provider registration and lifecycle in the official DeepSeek Harness dsh-crew profile on 3210.",
