					...
					children: [
						...
						(providerInventory?.recovery_transactions ?? []).filter((entry) => entry?.unresolved === true || !entry?.provider_id).map((entry) => /* @__PURE__ */ (0, react_jsx_runtime.jsxs)("div", {
							...
							children: [
								...
								/* @__PURE__ */ (0, react_jsx_runtime.jsx)("span", { style: { flex: 1 } }),
								entry.storage_id && /* @__PURE__ */ (0, react_jsx_runtime.jsx)("button", {
									type: "button",
									style: {
										...S.btn,
										padding: "2px 8px"
									...
									children: providerLifecycleBusy === `quarantine:${entry.storage_id}` ? copy.working : copy.recoveryQuarantine
								})
							]
