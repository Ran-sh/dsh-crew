...
const COPY = {
	zh: {
		...
		tierCardFlash: "DeepSeek V4 Flash",
		tierCardPro: "DeepSeek V4 Pro",
		tierState: "状态",
		tierStateDesc: {
			disabled: "禁用",
			manual: "手动（仅用户点名时可用）",
		...
		workerProviderDesc: {
			"follow-dsh": "跟随 DSH Provider · 用 DSH Models 当前选择的 provider（Flash/Pro 仍映射 deepseek-v4-flash / deepseek-v4-pro）",
			"deepseek-official": "DeepSeek Official · 始终使用内置 deepseek-official"
		},
	...
	en: {
		...
		workerProvider: "Worker Provider",
		workerProviderDesc: {
			"follow-dsh": "Follow DSH Provider · use the provider selected in DSH Models (Flash/Pro still map to deepseek-v4-flash / deepseek-v4-pro)",
			"deepseek-official": "DeepSeek Official · always use the built-in deepseek-official provider"
		},
				...
				(() => {
					...
					return /* @__PURE__ */ (0, react_jsx_runtime.jsxs)(react_jsx_runtime.Fragment, { children: [
						...
						block({
							...
							/* @__PURE__ */ (0, react_jsx_runtime.jsxs)("label", {
								...
								children: [/* @__PURE__ */ (0, react_jsx_runtime.jsx)("span", {
									...
									value: config.main_agent_mode ?? "coordinator-first",
						...
						tierCard("flash", {
							...
							d: "deepseek-v4-flash · fast and cheap"
						}),
						tierCard("pro", {
							t: copy.tierCardPro,
							d: "deepseek-v4-pro · stronger reasoning"
						}),
						/* @__PURE__ */ (0, react_jsx_runtime.jsx)("div", {
							style: S.group,
