		...
		children: [
			...
			/* @__PURE__ */ (0, react_jsx_runtime.jsxs)(PanelHeader, {
				...
				children: [
					/* @__PURE__ */ (0, react_jsx_runtime.jsxs)("span", {
						...
						children: ["Codex ", status?.codex?.ready ? copy.installed : copy.notReady]
					}),
					/* @__PURE__ */ (0, react_jsx_runtime.jsxs)("span", {
						style: S.chip(!!status?.claude?.ready),
						children: ["Claude ", status?.claude?.ready ? copy.installed : copy.notReady]
					}),
					/* @__PURE__ */ (0, react_jsx_runtime.jsxs)("span", {
						style: S.chip(!!status?.zcode?.ready),
						children: ["ZCode ", status?.zcode?.ready ? copy.installed : copy.notReady]
					}),
					/* @__PURE__ */ (0, react_jsx_runtime.jsx)("span", {
			...
			/* @__PURE__ */ (0, react_jsx_runtime.jsx)(CollapsibleSection, {
				...
				summary: sectionSummary(...[
					...
					"Claude",
					"ZCode"
				].map((name) => `${name} ${status?.[name.toLowerCase()]?.ready ? copy.installed : copy.notReady}`)),
