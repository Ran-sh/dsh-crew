...
<p align="center">
  <sub>GitHub: <code>Ran-sh/dsh-crew</code> &middot; Version actuelle du plugin : <code>0.1.0-rc.1</code> &middot; Testé avec DSH <code>0.1.0-rc.6</code></sub>
</p>
...
Installer depuis GitHub dans un profil DSH :
