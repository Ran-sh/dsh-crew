...
Deprecated ds-pro alias; prefer ds-worker/ds-reviewer for new work.
...
1. Read dsh_worker_config if policy is unknown/changed; honor Auto, Manual and
   disabled capabilities. Explicit review → role "reviewer"; otherwise role "worker". Preserve legacy_tier "pro".
